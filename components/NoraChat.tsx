...
/**
 * Floating widget, expanded by default when the page loads. Leads with a
 * call-first "home" screen — Nora's photo plus a prominent Call button — and
 * offers a text-chat alternative underneath.
 *
...
export function NoraChat() {
  ...
  // Let other parts of the page (e.g. the hero chat) open the widget, optionally
  // jumping straight into chat mode and seeding a first message.
  useEffect(() => {
      ...
      {!open ? (
        ...
        <PanelShell>
          ...
          <div className="flex items-center gap-2.5 bg-ink px-3.5 py-3">
            ...
            {/* Quick jump back to the call screen */}
            <button
              onClick={() => setMode("home")}
