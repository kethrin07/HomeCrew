        ...
        <section className="flex flex-col overflow-hidden rounded-[16px] border border-ink/10 bg-white">
          ...
          <div className="flex flex-1 flex-col gap-3 p-[18px]">
            <div ref={scrollRef} className="flex max-h-[420px] flex-1 flex-col gap-3 overflow-y-auto">
                ...
                <div
                  ...
                  className={
                    m.role === "u"
                      ...
                      : "max-w-[88%] self-start rounded-[14px_14px_14px_4px] bg-surface px-[14px] py-[11px] text-[14.5px] font-normal leading-[1.5] text-ink"
                  }
                >
                  {m.text}
                </div>
              ...
              {typing ? (
                <div className="max-w-[88%] self-start rounded-[14px_14px_14px_4px] bg-surface px-[14px] py-[11px] text-[14.5px] font-normal leading-[1.5] text-ink/50">
                  Nora is typing…
                </div>
              ) : null}
